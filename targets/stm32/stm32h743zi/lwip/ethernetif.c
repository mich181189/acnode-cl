...
static void low_level_init(struct netif *netif)
{
  ...
  // STM32 boards don't have a MAC address defined, so we make one
  // inspired by https://github.com/MXCHIP/mxos/blob/master/MXOS/net/LwIP/lwip_eth/TARGET_STM/stm32xx_emac.c
  uint32_t uid = HAL_GetDEVID();
  uint8_t macaddress[6]= {0xc8, 0x93, 0x46, (uid & 0x00ff0000) >> 16, (uid & 0x0000ff00) >> 8, (uid & 0x000000ff)};
