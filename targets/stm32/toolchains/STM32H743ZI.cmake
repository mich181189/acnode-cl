...
set(CMAKE_C_FLAGS "-g -Os -ffunction-sections -fdata-sections -ffreestanding --param max-inline-insns-single=500 -MMD -mthumb -mcpu=cortex-m7 -mfpu=fpv4-sp-d16 -mfloat-abi=soft -specs=nosys.specs " CACHE STRING "")

set(CMAKE_CXX_FLAGS "-g -Os -ffunction-sections -fdata-sections -ffreestanding --param max-inline-insns-single=500 -fno-threadsafe-statics --param max-inline-insns-single=500 -fno-rtti -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-threadsafe-statics  -MMD -mthumb -mcpu=cortex-m7 -mfpu=fpv4-sp-d16 -mfloat-abi=soft --specs=nosys.specs "  CACHE STRING "")
...
set(CMAKE_EXE_LINKER_FLAGS "-mthumb -mcpu=cortex-m7 -mfloat-abi=soft -mfpu=fpv4-sp-d16 -fsingle-precision-constant -ffreestanding -flto -T ${LINKER_SCRIPT}   -Xlinker -Map=output.map  -Wl,--entry=Reset_Handler " CACHE STRING "")
